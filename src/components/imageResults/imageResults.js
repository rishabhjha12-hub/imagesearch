...
const download=(filename, image)=>{
    var element = document.createElement('a');
    element.setAttribute('href', 'data:image/plain;charset=utf-8,' + encodeURIComponent(image));
...
class ImageResults extends Component{
    ...
    render()
    {
        ...
        return(
            ...
            <button className="btn" onClick={download} ></button>
            </Dialog>
            </div>
        )
    }
